...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fullSiteDictionary = {
    ...
    cidbHeroSubtitle: { en:"Officially accredited Safety Induction for Construction Workers. Centre Code: PLSICW20231022-068. Required for every individual on a Malaysian construction site.", ms:"Induksi Keselamatan yang diiktiraf rasmi untuk Pekerja Pembinaan. Kod Pusat: PLSICW20231022-068. Diwajibkan untuk setiap individu di tapak pembinaan Malaysia.", zh:"官方认证的建筑工人安全入门课程。中心代码：PLSICW20231022-068。马来西亚建筑工地上每个人必须持有。", ta:"கட்டுமான தொழிலாளர்களுக்கான அதிகாரப்பூர்வமான பாதுகாப்பு அறிமுகம். மையக் குறியீடு: PLSICW20231022-068. மலேசிய கட்டுமான தளத்தில் ஒவ்வொரு நபருக்கும் தேவை." },
    ...
    cidbProblemText: { en:"Under the CIDB Act 520, every person entering an active construction site must hold a valid CIDB Green Card (SICW). Site managers, main contractors, and developers face project delays and penalties if workers lack current certification. Many sites still rely on outdated or counterfeit cards.", ms:"Di bawah Akta CIDB 520, setiap orang yang memasuki tapak pembinaan aktif mesti memegang Kad Hijau CIDB (SICW) yang sah. Pengurus tapak, kontraktor utama, dan pemaju menghadapi kelewatan projek dan penalti jika pekerja kekurangan pensijilan semasa. Ramai tapak masih bergantung pada kad yang lapuk atau palsu.", zh:"根据CIDB第520号法令，每个进入活跃建筑工地的人员必须持有有效的CIDB绿卡（SICW）。如果工人缺乏当前认证，工地经理、主承包商和开发商将面临项目延误和处罚。许多工地仍在使用过时或伪造的绿卡。", ta:"CIDB சட்டம் 520-ன் கீழ், செயலில் உள்ள கட்டுமான தளத்தில் நுழையும் ஒவ்வொரு நபரும் செல்லுபடியாகும் CIDB பச்சை அட்டை (SICW) வைத்திருக்க வேண்டும். தள மேலாளர்கள், முதன்மை ஒப்பந்ததாரர்கள், மற்றும் உருவாக்குநர்கள் தொழிலாளர்கள் தற்போதைய சான்றிதழ் இல்லையென்றால் திட்ட தாமதங்கள் மற்றும் தண்டனைகளை எதிர்கொள்கிறார்கள். பல தளங்கள் இன்னும் காலாவதியான அல்லது போலி அட்டைகளை நம்பியுள்ளன." },
    ...
    cidbFailsText: { en:"Some providers offer cut-price \"certificates\" that CIDB does not recognise. Others conduct training in generic classrooms far from your site, causing worker downtime and transport costs. One-off training without renewal tracking leads to compliance gaps within months.", ms:"Some providers offer cut-price \"certificates\" that CIDB does not recognise. Others conduct training in generic classrooms far from your site, causing worker downtime and transport costs. One-off training without renewal tracking leads to compliance gaps within months.", zh:"Some providers offer cut-price \"certificates\" that CIDB does not recognise. Others conduct training in generic classrooms far from your site, causing worker downtime and transport costs. One-off training without renewal tracking leads to compliance gaps within months.", ta:"Some providers offer cut-price \"certificates\" that CIDB does not recognise. Others conduct training in generic classrooms far from your site, causing worker downtime and transport costs. One-off training without renewal tracking leads to compliance gaps within months." },
    ...
    cidbCtaSubtitle: { en:"Batch registration, on-site delivery, and renewal tracking for construction teams of any size across Johor and Malaysia.", ms:"Pendaftaran pukal, penghantaran di tapak, dan penjejakan pembaharuan untuk pasukan pembinaan sebarang saiz merentasi Johor dan Malaysia.", zh:"为柔佛和马来西亚各地任何规模的建筑团队提供批量注册、现场授课和续期跟踪。", ta:"தொகுப்பு பதிவு, தள வழங்கல், மற்றும் ஜொகூர் மற்றும் மலேசியாவில் எந்த அளவிலான கட்டுமான குழுக்களுக்கும் புதுப்பிப்பு கண்காணிப்பு." },
    ...
    oshCoordProblemText: { en:"Since 2022, Malaysian employers must appoint a certified OSH Coordinator if they employ 5 or more people. The coordinator must possess competency certificates recognised by DOSH. Many SMEs appoint an internal staff member without proper training, exposing the company and its directors to prosecution.", ms:"Sejak 2022, majikan Malaysia mesti melantik OSH Coordinator yang bertauliah jika mereka menggaji 5 atau lebih orang. Koordinator mesti memiliki sijil kompetensi yang diiktiraf DOSH. Ramai SME melantik kakitangan dalaman tanpa latihan yang sewajarnya, mendedahkan syarikat dan pengarah kepada pendakwaan.", zh:"自2022年起，马来西亚雇主如果雇用5人或以上，必须委任一名经认证的OSH协调员。协调员必须持有DOSH认可的胜任能力证书。许多中小企业委任未经适当培训的在职员工，使公司及其董事面临起诉风险。", ta:"2022 முதல், மலேசிய வேலையாளர்கள் 5 அல்லது அதற்கு மேற்பட்டவர்களை வேலைக்கு அமர்த்தினால் சான்றளிக்கப்பட்ட OSH ஒருங்கிணைப்பாளரை நியமிக்க வேண்டும். ஒருங்கிணைப்பாளர் DOSH-அங்கீகரிக்கப்பட்ட திறன் சான்றிதழ்களை வைத்திருக்க வேண்டும். பல SMEs சரியான பயிற்சி இல்லாமல் ஒரு உள்ளூர் ஊழியரை நியமிக்கிறார்கள், நிறுவனத்தையும் அதன் இயக்குநர்களையும் வழக்குக்கு ஆளாக்குகிறார்கள்." },
    ...
    oshCoordStakesP1: { en:"Failure to appoint a certified OSH Coordinator is a criminal offence. Directors and employers can face fines up to RM50,000 and/or imprisonment up to 2 years under Section 29A.", ms:"Gagal melantik OSH Coordinator yang bertauliah adalah kesalahan jenayah. Pengarah dan majikan boleh menghadapi denda sehingga RM50,000 dan/atau penjara sehingga 2 tahun di bawah Seksyen 29A.", zh:"未能委任经认证的OSH协调员是刑事犯罪。根据第29A条，董事和雇主可能面临最高5万令吉罚款和/或最高2年监禁。", ta:"சான்றளிக்கப்பட்ட OSH ஒருங்கிணைப்பாளரை நியமிக்கத் தவறுவது ஒரு குற்றவியல் குற்றம். இயக்குநர்கள் மற்றும் வேலையாளர்கள் பிரிவு 29A-ன் கீழ் RM50,000 வரை அபராதம் மற்றும்/அல்லது 2 ஆண்டுகள் வரை சிறைத்தண்டனை எதிர்கொள்ளலாம்." },
    ...
    auditFaq2A: { en:"We audit against the OSH Act 1994, Factories and Machinery Act 1967, USECHH Regulations 2000, Noise Regulations 1989, and relevant DOSH industry codes of practice.", ms:"Kami mengaudit terhadap Akta OSH 1994, Akta Kilang dan Jentera 1967, Peraturan USECHH 2000, Peraturan Bunyi 1989, dan kod amalan industri DOSH yang berkaitan.", zh:"我们根据OSH Act 1994、工厂和机械Act 1967、USECHH Regulations 2000、噪音法规1989以及相关DOSH行业实践守则进行审计。", ta:"OSH சட்டம் 1994, தொழிற்சாலைகள் மற்றும் இயந்திர சட்டம் 1967, USECHH விதிமுறைகள் 2000, இரைச்சல் விதிமுறைகள் 1989, மற்றும் சம்பந்தப்பட்ட DOSH தொழிற்துறை நடைமுறை குறியீடுகளுக்கு எதிராக தணிக்கை செய்கிறோம்." },
