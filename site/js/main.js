...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fullSiteDictionary = {
    ...
    oshCoordStakesP1: { en:"Failure to appoint a certified OSH Coordinator is a criminal offence. Directors and employers can face corporate fines up to RM500,000 and/or imprisonment under Section 29A of the OSH (Amendment) Act 2022.", ms:"Gagal melantik OSH Coordinator yang bertauliah adalah kesalahan jenayah. Pengarah dan majikan boleh menghadapi denda korporat sehingga RM500,000 dan/atau penjara di bawah Seksyen 29A Akta AKKP (Pindaan) 2022.", zh:"未能委任经认证的OSH协调员是刑事犯罪。根据2022年OSH（修正）法第29A条，董事和雇主可能面临最高50万令吉的公司罚款和/或监禁。", ta:"சான்றளிக்கப்பட்ட OSH ஒருங்கிணைப்பாளரை நியமிக்கத் தவறுவது ஒரு குற்றவியல் குற்றம். OSH (திருத்த) சட்டம் 2022 இன் பிரிவு 29A-ன் கீழ் இயக்குநர்கள் மற்றும் வேலையாளர்கள் RM500,000 வரை கார்ப்பரேட் அபராதம் மற்றும்/அல்லது சிறைத்தண்டனை எதிர்கொள்ளலாம்." },
