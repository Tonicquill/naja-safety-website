...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fullSiteDictionary = {
    ...
    heroSubtitle: {
      ...
      ta: "Naja Safety மலேசியா பணியிடங்களுக்கு பயிற்சி, ஆலோசனை மற்றும் இணக்க ஆதரவை வழங்குகிறது — OSH (திருத்தம்) சட்டம் 2022 மற்றும் CIDB விதிமுறைகளின் கீழ் சட்டபூர்வ தேவைகளை பூர்த்தி செய்ய உதவுகிறது."
    },
    heroLead: {
    ...
    wahStakesP1: { en:"A single fatal fall triggers immediate CIDB and DOSH investigations, potential project suspension, criminal charges under the OSH (Amendment) Act 2022, and massive insurance premium increases.", ms:"Satu kejadian jatuh yang membawa maut mencetuskan siasatan CIDB dan DOSH serta-merta, penggantungan projek berpotensi, tuduhan jenayah di bawah Akta Kilang dan Jentera, dan peningkatan premium insurans yang besar.", zh:"单次致命坠落会立即触发CIDB和DOSH调查、潜在的项目暂停、根据工厂和机械Act的刑事指控以及巨额保险费上涨。", ta:"ஒரு நபர் இறந்த விழுதல் உடனடி CIDB மற்றும் DOSH விசாரணைகளை, சாத்தியமான திட்ட நிறுத்தம், தொழிற்சாலைகள் மற்றும் இயந்திர சட்டத்தின் கீழ் குற்றவியல் குற்றச்சாட்டுகளை, மற்றும் பெரும் காப்பீட்டு பிரீமியம் அதிகரிப்புகளைத் தூண்டுகிறது." },
